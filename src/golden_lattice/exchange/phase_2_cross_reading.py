...
def build_phase_2_tagging_prompt(
    *,
    ...
    system = (
        ...
        "\n"
        "Each claim can be tagged in one or both dimensions, or neither. Use 'other' "
        "when a claim fits a dimension but no subtype applies — high 'other' rates "
        "signal vocabulary fitness issues, not your judgment. Empty tag arrays mean "
        "the claim does not fit that dimension at all.\n"
        "\n"
